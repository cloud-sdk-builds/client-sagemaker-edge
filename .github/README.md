...
[`@aws-sdk/client-sagemaker-edge`](https://www.npmjs.com/package/@aws-sdk/client-sagemaker-edge/v/3.1127.0).
...
- @aws-sdk/client-sagemaker-edge v3.1127.0 - [https://cloud-sdk-builds.github.io/?sdk=client-sagemaker-edge&version=3.1127.0](https://cloud-sdk-builds.github.io/?sdk=client-sagemaker-edge&version=3.1127.0)
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sagemaker-edge@3.1127.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-e0jrIlNCEMLHdB+toM51T+6XgaxiCxH16HpYdp+HzufqSeTrXENuE+ccRQI+eWhT
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-sagemaker-edge": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sagemaker-edge@3.1127.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sagemaker-edge@3.1127.0/index.min.mjs": "sha384-e0jrIlNCEMLHdB+toM51T+6XgaxiCxH16HpYdp+HzufqSeTrXENuE+ccRQI+eWhT"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-sagemaker-edge/blob/refs/tags/3.1127.0/LICENSE
```
